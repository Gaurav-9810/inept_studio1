...
{/* phone resoponsive */}
      ...
      <Modal
                                                                  ...
                                                                  <hr className='my-2 border-current'></hr>
                                                                      ...
                                                                      <hr className='my-2 border-current'></hr>
                                                                       ...
                                                                       <hr className='my-2 border-current'></hr>
                                                                        ...
                                                                        <p className=' text-sm font-extralight mt-3'>9625781411</p>
                                                                        <p className='text-sm font-extralight mt-2'>9625781411</p>
		...
		<div className='flex justify-center   relative overflow-hidden'>
			    <h1 class=" text-3xl sm:text-5xl md:text-7xl mt-44 font-semibold text-white z-10 ">WEB DEVELOPMENT</h1>
