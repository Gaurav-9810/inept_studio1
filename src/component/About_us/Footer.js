...
<div className=' footer h-auto    text-gray-400 py-5 px-4 text-lg leading-7 pt-14 '>
  <div class="row  sm:flex md:mx-4 my-4 mb-11 ">
      ...
      <div class="col sm:mx-2 sm:w-3/12 md:w-4/12 "> 
          ...
          <p className='text-sm my-2 md:leading-7 md:text-base lg:text-lg'>Street No-113/10 Sant Nagar Burari <br></br>New Delhi-110084 </p>
          <p className='text-sm my-2 md:leading-7 md:text-base lg:text-lg'>8800475391 9650088922</p>
          <p className='text-sm my-2 md:leading-7 md:text-base lg:text-lg' >ineptstudio@gmail.com</p>
      </div>
