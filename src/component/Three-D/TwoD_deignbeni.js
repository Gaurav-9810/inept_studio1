  ...
  return (
    <div className='mt-3 mx-4 sm:flex  sm:mx-10  pb-6 lg:mb-8 xl:mb-20'>
      <div className=' sm:w-1/2  xl:mx-auto    '>
          <h1 className='font-semibold text-4xl sm:text-5xl mb-6'>How 3D Design help your bussiness</h1>
        <ol className='text-lg lg:text-2xl sm:text-xl font-normal '>
          <li className='leading-10'> 1 - 3D design helps in creating a powerful impression of your brand on social media.</li>
          ...
          <li className='leading-10'>4 - 3D design builds the credibility of your brand.</li>
